...
import { db } from '@/db';
import { timeOffRequests, employees, tenants, timeOffPolicies } from '@/drizzle/schema';
...
/**
 * Generate certificate PDF for a time-off request
 */
export async function generateLeaveCertificate(
  ...
  const certificateData: LeaveCertificateData = {
    ...
    employee: {
      ...
      position: 'N/A', // TODO: get from assignment
      department: 'N/A', // TODO: get from assignment
    },
    leave: {
