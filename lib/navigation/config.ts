    ...
    items: [
      {
        ...
        href: '/performance',
        icon: Activity,
        description: 'Vue d\'ensemble des évaluations',
      },
      {
        id: 'performance-cycles',
        label: 'Cycles d\'Évaluation',
        href: '/performance/cycles',
        icon: Target,
        description: 'Gérer les cycles annuels',
      },
      {
        id: 'evaluations',
        label: 'Évaluations',
        ...
        icon: Star,
        description: 'Évaluations des collaborateurs',
      },
      {
        id: 'objectives',
        label: 'Objectifs',
      ...
      },
      {
        ...
        icon: MessageSquare,
        description: 'Reconnaissance et feedback',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        label: 'Modèles d\'Évaluation',
        href: '/performance/settings/templates',
        icon: FileText,
        description: 'Formulaires d\'évaluation personnalisés',
      },
      {
        id: 'competency-catalog',
        label: 'Catalogue Compétences',
        href: '/performance/settings/competencies',
        icon: Target,
        description: 'Référentiel des compétences',
      },
      {
        ...
        icon: BarChart,
        description: 'Sessions de calibration',
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        label: 'Évaluation Compétences',
        href: '/competencies/assessment',
        icon: UserCog,
        description: 'Auto-évaluation et gaps',
      },
      {
        id: 'gap-analysis',
        label: 'Analyse des Gaps',
        href: '/competencies/gap-analysis',
        icon: TrendingUp,
        description: 'Écarts de compétences',
      },
    ],
  },
];
